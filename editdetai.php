...
$sql = "SELECT * FROM detai WHERE id_detai='$id'";
  ...
  $mota = $_POST['mota'];
    ...
    $result_check = mysqli_query($conn, $sql_check);
        ...
        $loi1 = 'Tên đề tài đã tồn tại!';  
            ...
            if(empty($loi1)) {
            $sql = "UPDATE detai SET tendetai ='$tendetai', mota='$mota' WHERE id_detai='$id'";
            $result = mysqli_query($conn, $sql);
      ...
      <div class="thebentrai">
        ...
        <form method="post">
          ...
          <div class="form-group1">
            ...
            <textarea required name="mota" class="form-control" style="font-size:15px;width: 100%; height: 180px;"><?php echo $row['mota'];?>
            </textarea>
          </div><br>
          <div class="form-group1">
