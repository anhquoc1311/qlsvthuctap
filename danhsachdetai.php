...
<!-- Page Content -->
    ...
    <h3>Quản lý đề tài <small>- Danh sách đề tài của kỳ thực tập</small></h3>
                    ...
                    ?>
                                <tr>
                                        ...
                                        <td style="padding: 5px 0px">
                                          <a href="editdetai.php?id=<?php echo $rows['tendetai']; ?>">
                                            <button class="btnedit"><i class="fa-solid fa-pen-to-square"></i></button>
                                          </a>
                                        </td>
                                        
                                        <td style="padding: 5px 0px">
                                          <a onclick="return Del('<?php echo $rows['tendetai']; ?>')" href="xoadetai.php?id=<?php echo $rows['tendetai']; ?>">
